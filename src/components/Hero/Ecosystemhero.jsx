...
import Sermaraj from "../../assets/images/Sermaraj_dev.png";
        ...
        <div className="hero-layout">
          <div className={`hero-content ${isVisible ? "visible" : ""}`}>
            ...
            <div className="heading-container">
              <h1>
                <span className="line line-1">Delivering High Impact</span>
                ...
                <span className="line line-3">Technology</span>
              </h1>
            ...
            <p className="hero-description">
              Scalable architecture. Intelligent automation. Reliable delivery.
              Engineered to move your business forward.
            </p>
          ...
          <div className="hero-image">
            <img src={Sermaraj} alt="Hero Visual" />
          </div>
        </div>
      </div>
    </section>
