...
import saha from "../../assets/images/sahadevan_dev.png";
        ...
        <div className="hero-layout">
          <div className={`hero-content ${isVisible ? "visible" : ""}`}>
            ...
            <div className="heading-container">
              <h1>
                <span className="line line-1">Crafting Future-Ready</span>
                ...
                <span className="line line-3">Experiences</span>
              </h1>
            ...
            <p className="hero-description">
              From resilient cloud infrastructure to AI-driven automation, we
              engineer high-performance systems built for scale, speed, and
              stability.
            </p>
