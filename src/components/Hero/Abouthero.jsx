...
import Kishore from "../../assets/images/Kishore_dev.png";
        ...
        <div className="hero-layout">
          <div className={`hero-content ${isVisible ? "visible" : ""}`}>
            ...
            <p className="hero-description">
              We turn complex engineering challenges into high-performing,
              automated systems built for speed, scale, and long-term impact.
            </p>
          ...
          <div className="hero-image">
            <img src={Kishore} alt="Hero Visual" />
          </div>
        </div>
      </div>
    </section>
