...
import punitha from "../../assets/images/punitha_dev.png";
        ...
        <div className="hero-layout">
          <div className={`hero-content ${isVisible ? "visible" : ""}`}>
            ...
            <div className="heading-container">
              <h1>
                <span className="line line-1">Driving Enterprise</span>
                ...
                <span className="line line-3">Innovation</span>
              </h1>
            ...
            <p className="hero-description">
              We transform complex technology into scalable digital systems
              optimized for performance, automation, and continuous innovation.
            </p>
          ...
          <div className="hero-image">
            <img src={punitha} alt="Hero Visual" />
          </div>
        </div>
      </div>
    </section>
